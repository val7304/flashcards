...
public class Flashcard {
  ...
  /**
   * Retourne une copie défensive de la catégorie associée pour éviter l’exposition interne
   * (EI_EXPOSE_REP).
   *
  ...
  /**
   * Définit la catégorie associée en créant une copie défensive afin d’éviter toute modification
   * externe indésirable.
   *
